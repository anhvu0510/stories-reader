            ...
            <div className="flex flex-col gap-3 sm:gap-5">
              ...
              <div className="flex flex-col gap-2 sm:gap-3 bg-surface-container p-3 sm:p-4 rounded-xl sm:rounded-2xl">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[10px] sm:text-xs bg-primary/20 text-primary font-mono px-1.5 sm:px-2 py-0.5 rounded-md font-bold">{ Number(options.temperature).toFixed(1)}</span>
                </div>
                <input 
