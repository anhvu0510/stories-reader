...
export function ReaderQuickControl({
  ...
  return (
    ...
    >
      {/* Permanently Ultra-Translucent Pure Crystal Glass Dock Container with 3D Dark Blue Beveled Edge */}
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative bg-black/10 dark:bg-black/15 backdrop-blur-[1.5px] border border-blue-500/30 dark:border-blue-400/25 shadow-[0_16px_36px_rgba(0,0,0,0.5),_inset_0_1px_0.5px_0_rgba(255,255,255,0.45),_inset_0_-1px_0.5px_0_rgba(0,0,0,0.4)] rounded-full px-3 py-2 flex items-center justify-between gap-2 pointer-events-auto transition-all duration-300 overflow-hidden"
      >
        {/* LEFT GROUP: macOS Control Center Joined Segment Capsule with 3D Dark Blue Glass Rim */}
        <div className="relative z-10 flex items-center gap-1.5 bg-white/5 dark:bg-white/5 p-1 rounded-full border border-blue-500/20 dark:border-blue-400/20 shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.3),_inset_0_-1px_0.5px_rgba(0,0,0,0.3)] shrink-0">
          <button
            onClick={(e) => {
              e.stopPropagation();
              if (hasPrev) {
            ...
            className={`p-2 rounded-full flex items-center justify-center transition-all duration-150 ${
              hasPrev
                ? 'bg-white/5 dark:bg-white/5 border border-blue-500/20 text-white shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.3)] hover:bg-white/15 active:scale-90 cursor-pointer opacity-100'
        ...
        <div className="w-[1px] h-5 bg-gradient-to-b from-transparent via-blue-400/30 dark:via-blue-400/25 to-transparent shrink-0 mx-0.5" />
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center min-w-0 px-1 py-0.5">
          {isTTSActive ? (
            ...
            <div className="flex items-center gap-1 bg-white/5 dark:bg-white/5 backdrop-blur-sm px-2.5 py-1 rounded-full border border-blue-500/20 shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.3),_0_4px_12px_rgba(0,0,0,0.2)] animate-in fade-in duration-200">
              <button
                onClick={(e) => {
                  e.stopPropagation();
              ...
              <div className="w-[1px] h-3.5 bg-blue-400/30 mx-1" />
            ...
            <div className="flex flex-col items-center justify-center gap-1 max-w-full">
                    ...
                    <button
                      ...
                      className={`px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold tracking-tight inline-flex items-center justify-center transition-all duration-150 shrink-0 cursor-pointer ${
                        isActive
                          ...
                          : 'bg-white/5 dark:bg-white/5 text-white font-mono font-bold border border-blue-500/20 shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.2)] hover:bg-white/15 active:scale-95'
                      }`}
                      title={
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-0.5 rounded-full bg-white/5 dark:bg-white/5 border border-blue-500/20 text-primary font-bold shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.25)] hover:bg-white/15 hover:border-primary/50 transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-3.5 py-1.5 rounded-full bg-white/5 dark:bg-white/5 border border-blue-500/20 text-primary font-bold shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.25)] hover:bg-white/15 hover:border-primary/50 transition-all active:scale-95 cursor-pointer"
              title="Mở bảng chọn chương"
            >
              {!chapterDisplayLabel && (
        ...
        <div className="relative z-10 flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="p-2.5 rounded-full bg-white/5 dark:bg-white/5 border border-blue-500/20 text-white shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.3),_inset_0_-1px_0.5px_rgba(0,0,0,0.3)] hover:text-primary hover:rotate-45 hover:bg-white/15 transition-all duration-300 active:scale-90"
          ...
          {!isOfflineMode && (
            <button
              ...
              className="p-2.5 rounded-full bg-amber-400/15 dark:bg-amber-400/10 border border-amber-300/40 text-amber-300 shadow-[0_4px_16px_rgba(245,158,11,0.3),_inset_0_1px_0.5px_rgba(255,255,255,0.4)] hover:bg-amber-400/25 transition-all active:scale-90"
              title="Dịch AI"
            >
              <Sparkles size={16} />
            </button>
