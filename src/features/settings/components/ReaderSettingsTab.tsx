...
export function ReaderSettingsTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Theme selection */}
      <div>
        <label className="text-xs font-bold text-on-surface flex items-center justify-between mb-2.5">
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border flex items-center justify-between gap-2 transition-all text-xs active:scale-[0.985] ${
                  isSelected
                    ...
                    : 'bg-white/5 hover:bg-white/10 border border-white/10 text-on-surface'
                }`}
              >
      ...
      {/* Line Height */}
      <div>
        <label className="text-xs font-bold text-on-surface flex items-center gap-1.5 mb-2">
        ...
        <div className="grid grid-cols-4 gap-2">
          {[1.2, 1.4, 1.6, 1.8].map((lh) => (
            <button
              ...
              className={`py-1.5 rounded-xl border text-xs font-bold transition-all active:scale-95 ${
                lineHeight === lh
                  ? 'bg-primary/20 hover:bg-primary/25 border border-primary/50 text-primary font-black shadow-xs'
                  : 'bg-white/5 hover:bg-white/10 border border-white/10 text-on-surface'
              }`}
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-20 px-3 py-1.5 rounded-xl bg-white/10 border border-white/15 shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.2)] text-xs text-primary font-mono font-bold text-center focus:border-primary/60 focus:outline-none transition-all"
          />
      ...
      <div className="pt-3 border-t border-white/10 space-y-4">
        <div className="flex items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/10">
          <div>
            <div className="text-xs font-bold text-on-surface">Bật Từ điển Thay thế</div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-1.5 rounded-xl bg-white/10 border border-white/15 shadow-[inset_0_1px_0.5px_rgba(255,255,255,0.2)] text-xs text-primary font-mono font-bold focus:border-primary/60 focus:outline-none transition-all"
            />
          </div>
          <div>
